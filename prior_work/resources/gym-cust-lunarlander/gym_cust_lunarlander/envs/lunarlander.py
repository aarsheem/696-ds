...
class LunarLanderCust(gym.Env, EzPickle):
    metadata = {
    ...
    def reset(self):
        ...
        initial_x = VIEWPORT_W/SCALE/2 + (random.randrange(-1,1)*VIEWPORT_W/SCALE/2.1)
...
class LunarLanderCustContinuous(LunarLanderCust):
    continuous = True
